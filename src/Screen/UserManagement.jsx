                  ...
                  <table className="table">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>01/01/2023</td>
                        <td><span className="green-text semi-bold"> Active</span></td>
                        <td className="text-center"><a href="users-management-view.php" className="fas fa-eye table-eye" /></td>
                      </tr>
                      <tr>
                        <td>02</td>
                        <td>abc</td>
                        <td>abc@example.com</td>
                        <td>01/01/2023</td>
                        <td><span className="t-red-text semi-bold"> Inactive</span></td>
                        <td className="text-center"><a href="users-management-view.php" className="fas fa-eye table-eye" /></td>
                      </tr>
                    </tbody>
                  </table>
