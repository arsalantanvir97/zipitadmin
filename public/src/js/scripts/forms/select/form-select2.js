  ...
  // Basic Select2 select
    ...
    function formatRepo (repo) {
      ...
      var markup = "<div class='select2-result-repository clearfix'>" +
        "<div class='select2-result-repository__avatar'><img src='../../../../../../src/js/scripts/forms/select/" + repo.owner.avatar_url + "' /></div>" +
    ...
    function formatState (state) {
      if (!state.id) { return state.text; }
        ...
        var $state = $(
          '<span><img src="../../../../../../src/js/app-assets/images/flags/' + state.element.value.toLowerCase() + '.png" class="img-flag" /> ' + state.text + '</span>'
        );
        return $state;
      }
    }
