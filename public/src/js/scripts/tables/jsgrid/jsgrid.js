...
fields: [
    ...
    { name: "county", type: "select", items: db.countries, valueField: "Id", textField: "Name" },
...
$("#validation").jsGrid({
    ...
    fields: [
        ...
        { name: "county", type: "select", items: db.countries, valueField: "Id", textField: "Name",
            validate: { message: "county should be specified", validator: function(value) { return value > 0; } } },
        { name: "Married", type: "checkbox", title: "Is Married", sorting: false },
        { type: "control" }
    ]
});
